...
<div class="container"> 
    ...
    <div class="hk-pg-header mb-50">
        <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="users"></i></span></span>Inline Tasklist <?php echo $bagian['bagian'] ?></h4>
    </div>
    <!-- /Title -->
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-3 col-form-label" align="">Jenis Task</label>
                                            <div class="col-sm-8">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form id="form_tambah_tasklist">
                ...
                <div class="form-group">
                    <label for="nama">Jenis Task</label>
                    <select class="form-control" id="jenis_task">
                    <?php foreach($d_karyawan as $row){?>
                        <option value="<?= $row['id_jenis_tasklist'];?>"><?= $row['jenis_tasklist'];?></option>
                    <?php }?>
                    </select>
                </div>
                <div class="form-group">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-success btn-wth-icon btn-rounded icon-right"><span class="btn-text">Tambah Data Tasklist</span> <span class="icon-label"><span class="fa fa-check"></span> </span></button>
            </div>
            </form>
        </div>
    </div>
...
<script>
    $(document).ready(function () {
        ...
        var data_mon_pegawai = $('#tabel_mon_pegawai').DataTable({
             ...
             "ajax"         : {
                "url"   : "<?php echo base_url("data/tampil_task_inline/$id_bagian") ?>",
                "type"  : "POST",
                "data"  : function (data) {
