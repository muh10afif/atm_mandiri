...
<div class="container"> 
    ...
    <div class="hk-pg-header mb-50">
        <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="users"></i></span></span>CrossTask <?php echo $bagian['bagian'] ?></h4>
    </div>
    <!-- /Title -->
...
<script>
    $(document).ready(function () {
        ...
        var data_mon_pegawai = $('#tabel_mon_pegawai').DataTable({
             ...
             "ajax"         : {
                "url"   : "<?php echo base_url("data/tampil_task/$id_bagian") ?>",
                "type"  : "POST",
                "data"  : function (data) {
